...
from core.simple_auth import SimpleUser
...
class TestSynchronousMonteCarlo:
    ...
    @patch("api.routes.monte_carlo.get_current_user_simple")
    @patch("api.routes.monte_carlo.get_session")
    def test_sync_monte_carlo_basic(self, mock_get_session, mock_get_current_user, mock_simple_user, mock_jwt_token):
