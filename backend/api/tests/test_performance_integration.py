...
from infrastructure.db_indexes import IndexManager
...
class TestJobRepositoryIntegration:
    ...
    def test_get_job_by_id_caching(self, job_repo):
        ...
        assert callable(getattr(job_repo, 'get_job_by_id'))
    ...
    def test_get_job_counts_by_status_caching(self, job_repo):
        ...
        assert callable(getattr(job_repo, 'get_job_counts_by_status'))
...
class TestJobManagerIntegration:
    ...
    def test_get_job_progress_caching(self):
        ...
        assert callable(getattr(MonteCarloJobManager, 'get_job_progress'))
