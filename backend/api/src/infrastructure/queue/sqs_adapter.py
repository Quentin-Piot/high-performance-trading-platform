...
class SQSQueueAdapter(QueueInterface[MonteCarloJobPayload]):
    ...
    async def dequeue(self, timeout_seconds: int | None = None) -> Job[MonteCarloJobPayload] | None:
    ...
    async def get_job_status(self, job_id: str) -> Job[MonteCarloJobPayload] | None:
