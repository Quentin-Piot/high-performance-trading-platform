...
from domain.schemas.backtest import MetricsDistribution, EquityEnvelope
...
def monte_carlo_worker(args) -> Optional[MonteCarloResult]:
    """
    ...
    try:
        ...
        if strategy_name == "sma_crossover":
            result = run_sma_crossover(
                synthetic_source,
                strategy_params["sma_short"],
                strategy_params["sma_long"]
            )
