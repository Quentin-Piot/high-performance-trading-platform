  ...
  container_definitions = jsonencode([
    {
      ...
      essential = true
      environment = [
        { name = "POSTGRES_DB", value = "trading" },
        { name = "POSTGRES_USER", value = "trading" },
        { name = "POSTGRES_PASSWORD", value = "tradingpassword" }
      ]
      mountPoints = [
        {
    ...
    },
    {
      ...
      environment = [
        ...
        { name = "DATABASE_NAME", value = "trading" },
        { name = "DATABASE_USER", value = "trading" },
        { name = "DATABASE_PASSWORD", value = "tradingpassword" }
      ]
      dependsOn = [
