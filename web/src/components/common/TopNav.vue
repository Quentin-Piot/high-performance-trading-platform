...
<template>
    <nav class="relative">
        <!-- Gradient background -->
        <div
            class="absolute inset-0 bg-gradient-to-r from-trading-blue/5 via-trading-purple/5 to-trading-cyan/5 rounded-2xl"
        ></div>

        <!-- Navigation content -->
        <div
            class="relative flex items-center justify-between py-3 px-4 sm:py-4 sm:px-6 backdrop-blur-sm border border-white/10 rounded-2xl shadow-soft"
        >
            ...
            >
                <div class="relative">
                    ...
                    <div
                        class="text-2xl sm:text-3xl font-bold text-trading-blue group-hover:text-trading-cyan transition-all duration-500"
                    >
                        HPTP
                    </div>
                    <!-- Effet de brillance -->
                ...
                <div class="hidden sm:flex flex-col">
                    <span
                        class="text-sm font-medium text-foreground/90 group-hover:text-trading-blue transition-colors"
                    >
                        {{ t("nav.title") }}
                    </span>
                    <span
            ...
            <div class="flex lg:hidden items-center gap-2">
                ...
                <div class="relative">
                    <Select v-model="selectedLocale">
                        ...
                        >
                            <Globe
                                class="size-4 text-trading-cyan group-hover:rotate-180 transition-transform duration-500"
                            />
                        </SelectTrigger>
                        <SelectContent
        ...
        <!-- Subtle glow effect -->
        <div
            class="absolute inset-0 bg-gradient-to-r from-trading-blue/10 via-trading-purple/10 to-trading-cyan/10 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10"
        ></div>
    </nav>
</template>
