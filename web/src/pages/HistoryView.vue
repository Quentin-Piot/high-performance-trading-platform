<template>
    <BaseLayout>
        <section class="animate-scale-in" style="animation-delay: 0.1s">
            <Card
                class="border-0 shadow-medium bg-gradient-to-br from-card via-card to-secondary/20 mb-6"
            >
                <CardHeader class="pb-3 sm:pb-4 p-4 sm:p-6">
                    ...
                    >
                        <div class="space-y-1">
                            <CardTitle
                                class="flex items-center gap-3 text-2xl sm:text-3xl"
                            >
                                <div
                                    class="rounded-xl bg-trading-cyan/10 p-3 text-trading-cyan"
                                >
                        ...
                        <div class="flex items-center gap-3 w-full sm:w-auto">
                            <Select v-model="selectedStrategy">
                                <SelectTrigger
                                    class="w-full sm:w-48 border-0 bg-secondary/50 hover:bg-secondary/70 transition-smooth shadow-soft"
                                >
                                    <SelectValue
                                        :placeholder="
                                            t('history.filter_by_strategy')
                                        "
                                    />
                                </SelectTrigger>
                                <SelectContent class="border-0 shadow-strong">
                                    <SelectItem value="all">{{
                                        t("history.all_strategies")
                                    }}</SelectItem>
                                    <SelectItem
        ...
        <section
            v-if="stats"
            class="animate-scale-in mb-6"
            style="animation-delay: 0.2s"
        >
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <Card
                    class="border-0 shadow-medium bg-gradient-to-br from-card via-card to-secondary/10 hover:shadow-strong transition-all duration-300 hover-scale"
                >
                    <CardContent class="p-3">
                        <div class="flex items-center">
                            <div
                                class="rounded-xl bg-trading-blue/10 p-3 text-trading-blue"
                            >
                                <BarChart3 class="size-6 sm:size-7" />
                            </div>
                            <div class="ml-4">
                                ...
                                >
                                    {{ t("history.stats.total_backtests") }}
                                </p>
                ...
                >
                    <CardContent class="p-3">
                        <div class="flex items-center">
                            <div
                                class="rounded-xl bg-trading-green/10 p-3 text-trading-green"
                            >
                ...
                >
                    <CardContent class="p-3">
                        <div class="flex items-center">
                            <div
                                class="rounded-xl bg-trading-purple/10 p-3 text-trading-purple"
                            >
                            ...
                            <div class="ml-4">
                                <p
                                    class="text-sm font-medium text-muted-foreground"
                                >
                                    {{ t("history.stats.avg_sharpe") }}
                                </p>
                                <p class="text-2xl font-bold">
                                    {{
                                        stats.avg_sharpe
                                            ? stats.avg_sharpe.toFixed(3)
                                            : "N/A"
                                    }}
                                </p>
                            </div>
                ...
                >
                    <CardContent class="p-3">
                        <div class="flex items-center">
                            <div
                                class="rounded-xl bg-trading-orange/10 p-3 text-trading-orange"
                            >
                            ...
                            <div class="ml-4">
                                <p
                                    class="text-sm font-medium text-muted-foreground"
                                >
                                    {{ t("history.stats.monte_carlo_runs") }}
                                </p>
                                <p class="text-2xl font-bold">
                                    {{ stats.total_monte_carlo_runs }}
                                </p>
                            </div>
                        </div>
                    </CardContent>
            ...
            >
                <CardHeader class="pb-3 sm:pb-4 p-4 sm:p-6">
                    <CardTitle class="flex items-center gap-3 text-xl">
                        <div
                            class="rounded-xl bg-trading-cyan/10 p-2 text-trading-cyan"
                        >
                ...
                <CardContent class="p-4 sm:p-6 pt-0">
                    ...
                    <div v-else-if="error" class="text-center py-12">
                        <div
                            class="rounded-xl bg-trading-red/5 text-trading-red p-4 shadow-soft animate-slide-up"
                        >
                            <div
                            ...
                            <Button
                                variant="outline"
                                size="sm"
                                class="border-trading-red/20 hover:border-trading-red hover:bg-trading-red/5 hover:text-trading-red"
                                @click="loadHistory"
                            >
                                {{ t("common.retry") }}
                            </Button>
                    ...
                    <div v-else-if="!history.length" class="text-center py-12">
                        <div class="flex flex-col items-center gap-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <Button
                                    class="bg-trading-blue hover:bg-trading-blue/90 transition-smooth shadow-soft hover-scale"
                                    @click="navigateToSimulate"
                                >
                    ...
                    <div v-else class="space-y-4">
                        <div
                            ...
                            :key="item.id"
                            class="border-0 rounded-xl p-4 sm:p-6 bg-gradient-to-br from-secondary/30 via-secondary/20 to-secondary/10 hover:shadow-medium transition-all duration-300 hover-scale shadow-soft"
                        >
                            <div
                                ...
                                <div class="flex-1 w-full">
                                    ...
                                    >
                                        <Badge
                                            ...
                                            "
                                            class="rounded-lg px-3 py-1 font-medium shadow-soft"
                                        >
                                            {{
                                        ...
                                        <Badge
                                            v-if="item.monte_carlo_runs > 1"
                                            variant="secondary"
                                            class="rounded-lg px-3 py-1 font-medium shadow-soft border-trading-purple/30 text-trading-purple"
                                        >
                                            Monte Carlo ({{
                                                item.monte_carlo_runs
                                            }}
                                            runs)
                                        </Badge>
                                        <Badge
                                    ...
                                    <div
                                        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 text-sm mb-4"
                                    >
                                        <div class="space-y-1">
                                            <p
                                        ...
                                        <div
                                            v-if="item.total_return !== null"
                                            class="space-y-1"
                                        >
                                            <p
                                                class="text-muted-foreground font-medium"
                                            >
                                                {{ t("history.total_return") }}
                                            </p>
                                            <p
                                        ...
                                        <div
                                            v-if="item.sharpe_ratio !== null"
                                            class="space-y-1"
                                        >
                                            <p
                                                class="text-muted-foreground font-medium"
                                            >
                                                {{ t("history.sharpe_ratio") }}
                                            </p>
                                            <p
                                                class="font-bold text-lg text-trading-purple"
                                            >
                                                {{
                                        ...
                                        <div
                                            v-if="item.max_drawdown !== null"
                                            class="space-y-1"
                                        >
                                            <p
                                                class="text-muted-foreground font-medium"
                                            >
                                                {{ t("history.max_drawdown") }}
                                            </p>
                                            <p
                                                class="font-bold text-lg text-trading-red"
                                            >
                                                {{
                                                    item.max_drawdown.toFixed(
                                                        2,
                                                    )
                                                }}%
                                            </p>
                                    ...
                                    <div
                                        class="mt-3 p-3 rounded-lg bg-secondary/30 text-xs"
                                    >
                                        <span
                                            class="font-semibold text-trading-blue"
                                            >{{
                                    ...
                                    <div
                                        v-if="
                                            item.datasets_used &&
                                            item.datasets_used.length
                                        "
                                        class="mt-2 p-3 rounded-lg bg-secondary/30 text-xs"
                                    >
                                        <span
                                            class="font-semibold text-trading-cyan"
                                            >{{ t("history.datasets") }}:</span
                                        >
                                        <span
                                            class="text-muted-foreground ml-2"
                                            >{{
                                    ...
                                    <AlertDialog>
                                        <AlertDialogTrigger as-child>
                                            <Button
                                                variant="destructive"
                                                size="sm"
                                                class="rounded-lg border-0 bg-trading-red/10 hover:bg-trading-red/20 text-trading-red hover:text-trading-red transition-smooth shadow-soft hover-scale"
                                            >
                                                <Trash2 class="size-4" />
                                            </Button>
                                        </AlertDialogTrigger>
                                        <AlertDialogContent
                                            class="border-0 shadow-strong bg-gradient-to-br from-card via-card to-secondary/10"
                                        >
                                            <AlertDialogHeader>
                                                <AlertDialogTitle
                                                    class="flex items-center gap-3 text-trading-red"
                                                >
                                                    <div
                                                        class="rounded-full bg-trading-red/10 p-2"
                                                    >
                                                        <Trash2
                                                            class="size-5"
                                                        />
                                                ...
                                                >
                                                    {{
                                                        t(
                                                            "history.confirm_delete_description",
                                                        )
                                                    }}
                                                </AlertDialogDescription>
                                            </AlertDialogHeader>
                                            <AlertDialogFooter>
                                                <AlertDialogCancel
                                                    class="rounded-lg border-0 bg-secondary/50 hover:bg-secondary/70 transition-smooth shadow-soft"
                                                >
                                                    {{ t("common.cancel") }}
                                                </AlertDialogCancel>
                                                <AlertDialogAction
                        ...
                        >
                            <Card
                                class="border-0 shadow-medium bg-gradient-to-br from-card via-card to-secondary/10"
                            >
                                <CardContent class="p-4 sm:p-6">
                                    ...
                                    >
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <span
                                                class="text-sm font-medium px-3 py-1 rounded-lg bg-trading-blue/10 text-trading-blue"
